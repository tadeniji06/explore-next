							...
							if (markDef && markDef._type === "link") {
								content = (
									<a
										key={childIndex}
										href={markDef.href}
										className='text-[#bc3908] hover:underline'
		...
		switch (style) {
			...
			case "blockquote":
				return (
					<blockquote
						key={index}
						className='border-l-4 border-[#bc3908] pl-4 my-6 italic text-gray-700'
					>
						{renderChildren(children)}
					</blockquote>
				);
		...
		<div className='min-h-screen bg-gray-50'>
			...
			<div className='bg-white border-b'>
				<div className='container mx-auto px-4 py-4'>
					<Link
						href='/blog'
						className='inline-flex items-center gap-2 text-gray-600 hover:text-[#bc3908] transition-colors duration-200'
					>
					...
					{post.categories && post.categories.length > 0 && (
						<div className='flex flex-wrap gap-2 mb-4'>
							{post.categories.map((category) => (
								<span
									key={category._id}
									className='px-3 py-1 bg-[#bc3908]/10 text-[#bc3908] text-sm rounded-full font-medium'
								>
									{category.title}
								</span>
							))}
						...
						<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
							{relatedPosts.map((relatedPost) => (
								...
								>
									...
									<div className='p-4'>
										<h3 className='font-bold text-gray-900 mb-2 group-hover:text-[#bc3908] transition-colors duration-200 line-clamp-2'>
											{relatedPost.title}
										</h3>
